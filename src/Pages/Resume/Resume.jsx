    ...
    return (
        ...
        <div className='ResumeMainDev'>
            <div class="button_design">
                <div class="left_btn">
                    <a href="/assets/img/ravinaResume.pdf" target="_blank" rel="noopener noreferrer">Download Pdf</a>
                </div>
                <div class="right_btn">
                ...
                <div class="container">
                    <header>
                        <div class="left_header">
                            <img src="/assets/" alt="logo" class="profile" />
                            <div class="details">
                                <h2>Ravina</h2>
                                <h3>Front End Web Developer</h3>
                                <div>
                                    <a href="https://www.linkedin.com/in/ravina-duggal-634236193/" rel="noopener noreferrer" target="_blank">LinkedIn Profile</a>
                                    <a href="https://github.com/Ravina-Duggal" rel="noopener noreferrer" target="_blank">Github</a>
                                </div>
                            </div>
                        </div>
                        <div class="right_header">
                            <div class="contact1">
                                <a href="tel:+919878947313" rel="noopener noreferrer" className='detailslist'>+919878947313</a>
                                <img src="/assets/icon-things1.png" alt="Phone" class="contact_icons" />
                            </div>
                            <div class="email-div contact1">
                                <a href="mailto:ravinaduggal14@gmail.com" rel="noopener noreferrer" className='detailslist'>ravinaduggal14@gmail.com</a>
                        ...
                        <div class="transing_main_div">
                            <div class="project_div">
                                ...
                                <div class="tr_div">
                                    <h4>TRAINING</h4>
                                    <p>
                                    Guru Nanak Dev University Regional Campus, Jalandhar for providing me four weeks Summer Institutional training.
                                    </p>
                                </div>
                                <div class="pro_links">
                                    <h4>PROJECTS</h4>
                            ...
                            <div class="education">
                                ...
                                <div class="tenth">
                                    ...
                                    <span>2016 - 2017</span>
                                    <p>
                                        2016-2017 I have done my matric education with 80% from Tyag Murti Vishwanath Acharaya Vidhya Mandir School, jalandhar.
                                    </p>
                                </div>
                                <div class="sr-sec">
                                    ...
                                    <span>2018 - 2019</span>
                                    <p>
                                        I have done my secondary education with 77% (non-medical) from
                                ...
                                <div class="graducation">
                                    ...
                                    <span>2019 - 2023</span>
                                    <p>
                                        Bachelor of Electronics and computer engineering . From- Guru Nanak Dev University Regional Campus ,Jalandhar
                                    </p>
                                </div>
                            </div>
                        </div>
